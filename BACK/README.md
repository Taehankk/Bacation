...
**걸음마** 들의 **Git Commit Message Rules**
...
- 각자가 기간 동안 맡은 역할을 전부 수행하면, 각자 브랜치에서 develop브랜치로 Pull Request를 보냅니다.  
  **BE 브랜치로의 Pull Request는 상대방의 코드리뷰 후에 merge할 수 있습니다.**

### ❗️ branch naming convention

- BE
- {BE}feature/jira_number
- {BE}fix/jira_number
- {BE}release/jira_number
- {BE}hotfix/jira_number

예시 >

```
  {BE}feature/#3-user-post-api
```
